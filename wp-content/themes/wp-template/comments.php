...
<div id="comments" class="comments-area card">
		...
		<h5 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					...
					esc_html( _n( '%d комментарий', '%d комментариев', get_comments_number(), 'wp-bootstrap-4' ) ),
	...
	<?php if( comments_open() ) : ?>
		<div class="wb-comment-form">
			<?php
				$wp_bootstrap_4_comment_field = '<div class="comment-form-textarea form-group col-md-12"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" class="form-control" placeholder="'. esc_attr__('Ну давай расскажи как всё плохо...*', 'wp-bootstrap-4') .'"></textarea></div>';
				...
				comment_form( array(
					...
					'title_reply'          => esc_html__('Оставь коммент', 'wp-bootstrap-4'),
					'cancel_reply_link'    => esc_html__('Cancel', 'wp-bootstrap-4'),
					'label_submit'         => esc_html__('Оставить комментарий', 'wp-bootstrap-4'),
