        ...
        <article class="media wp-bootstrap-4-comment">
            ...
            <div class="media-body">
                ...
                <small class="date text-muted"><?php printf( // WPCS: XSS OK.
                                                        ...
                                                        esc_html__('%1$s в %2$s', 'wp-bootstrap-4'),
                                                        get_comment_date(),
                                                        get_comment_time()
                                                    ); ?></small>
                ...
                <small class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => esc_html__( 'Ответить', 'wp-bootstrap-4' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ), $comment->comment_ID ); ?>
					<?php edit_comment_link( esc_html__( 'Редактировать', 'wp-bootstrap-4' ) ); ?>
				</small>
            </div>
            <!-- /.media-body -->
        </article>
